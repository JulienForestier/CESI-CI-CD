...
public static class ChatEndpoints
{
    public static void MapChatEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        api.MapPost("/conversations", StartConversationAsync).RequireAuthorization();
        api.MapGet("/conversations", GetConversationsAsync).RequireAuthorization();
        api.MapGet("/conversations/{id:guid}/messages", GetMessagesAsync).RequireAuthorization();
        api.MapPost("/conversations/{id:guid}/messages", SendMessageAsync).RequireAuthorization();
    }
