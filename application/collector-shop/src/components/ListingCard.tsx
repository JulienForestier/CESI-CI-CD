...
export function ListingCard({ listing }: { listing: Listing }) {
  return (
    <div className="relative overflow-hidden rounded-xl border-[1.5px] border-ink bg-surface shadow-[3px_3px_0_rgba(41,33,27,0.15)] transition hover:-translate-y-0.5">
